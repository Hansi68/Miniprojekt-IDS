...
function draw() {
  ...
  if (confidence > 0.85) {
    // Reference: Full implement based on Mads by Mikkel Pedersen - måske fjerne når det står i toppen
...
function foodIdea() {
  ...
  if (millis() - timer > 2000) {
    ...
    httpGet(url, "json", false, function (response) {
      ...
      //print(ingredients); hvis vi ønsker at printe i consol - ikke nødvendigt
    });
  }
}
